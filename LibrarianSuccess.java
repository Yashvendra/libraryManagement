...
public class LibrarianSuccess extends JFrame {
	...
	public LibrarianSuccess() {
		...
		lblLibrarianSection.setFont(new Font("URW Gothic L", Font.BOLD, 20));
		...
		btnViewBooks.setFont(new Font("Purisa", Font.PLAIN, 15));
		...
		btnViewIssuedBooks.setFont(new Font("Purisa", Font.PLAIN, 15));
		...
		btnReturnBook.setFont(new Font("Purisa", Font.PLAIN, 15));
