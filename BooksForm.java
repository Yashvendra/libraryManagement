...
public class BooksForm extends JFrame {
	...
	public BooksForm() {
		...
		lblAddBooks.setFont(new Font("URW Gothic L", Font.BOLD, 20));
		
		JLabel lblCallNo = new JLabel("Call No:");
		lblCallNo.setFont(new Font("Purisa", Font.PLAIN, 15));
		
		JLabel lblName = new JLabel("Name:");
		lblName.setFont(new Font("Purisa", Font.PLAIN, 15));
		JLabel lblAuthor = new JLabel("Author:");
		lblAuthor.setFont(new Font("Purisa", Font.PLAIN, 15));
		JLabel lblPublisher = new JLabel("Publisher:");
		lblPublisher.setFont(new Font("Purisa", Font.PLAIN, 15));
		JLabel lblQuantity = new JLabel("Quantity:");
		lblQuantity.setFont(new Font("Purisa", Font.PLAIN, 15));
		...
		btnAddBooks.setFont(new Font("Purisa", Font.PLAIN, 15));
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
					.addGap(161)
					.addComponent(btnAddBooks, GroupLayout.PREFERRED_SIZE, 130, GroupLayout.PREFERRED_SIZE)
