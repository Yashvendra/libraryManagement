...
public class AdminSuccess extends JFrame {
	...
	public AdminSuccess() {
		...
		lblAdminSection.setFont(new Font("URW Gothic L", Font.BOLD, 22));
		...
		btnViewLibrarian.setFont(new Font("Purisa", Font.PLAIN, 15));
		...
		btnDeleteLibrarian.setFont(new Font("Purisa", Font.PLAIN, 15));
		
		JButton btnLogout = new JButton("Logout");
		btnLogout.setFont(new Font("Rockwell",Font.PLAIN,15));
		...
		btnLogout.setFont(new Font("Purisa", Font.PLAIN, 15));
		GroupLayout gl_contentPane = new GroupLayout(Panel);
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addContainerGap(150, Short.MAX_VALUE)
					.addComponent(lblAdminSection, GroupLayout.PREFERRED_SIZE, 170, GroupLayout.PREFERRED_SIZE)
					.addGap(123))
